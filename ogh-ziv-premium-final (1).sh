...
draw_vps() {
    ...
    printf  " ${A1}║${NC} ${A3}HOST${NC} %-22s ${A1}│${NC} ${A3}OS${NC} Ubuntu 20.04                ${A1}║${NC}
" "$host"
    printf  " ${A1}║${NC} ${A3}IP${NC}   %-22s ${A1}│${NC} ${A3}DOMAIN${NC} %-21s ${A1}║${NC}
" "$ip" "$domain"
    printf  " ${A1}║${NC} ${A3}PORT${NC} %-22s ${A1}│${NC} ${A3}BRAND${NC} OGH-ZIV                  ${A1}║${NC}
" "$port"
    printf  " ${A1}║${NC} ${A3}CPU${NC}  %-3s%%                     ${A1}│${NC} ${A3}RAM${NC} %s/%s MB              ${A1}║${NC}
" "$cpu" "$ram_u" "$ram_t"
    printf  " ${A1}║${NC} ${A3}DISK${NC} %-57s ${A1}║${NC}
" "$disk"
    printf  " ${A1}║${NC} ${LG}STATUS : RUNNING${NC}   │   ${A3}AKUN : %s${NC}   │   ${Y}EXP : %s${NC}          ${A1}║${NC}
" "$total" "$(exp_count)"
    echo -e " ${A1}╚════════════════════════════════════════════════════════════════════╝${NC}"
}
