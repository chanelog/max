...
echo -e " ${A1}╔══════════════════════════════════════════════════════════════════════════════╗${NC}"
echo -e " ${A1}║${NC}                                                                          ${A1}║${NC}"
echo -e " ${A1}║${NC}      ${AL} ██████╗  ██████╗ ██╗  ██╗        ███████╗██╗██╗   ██╗ ${NC}         ${A1}║${NC}"
echo -e " ${A1}║${NC}      ${A3}██╔═══██╗██╔════╝ ██║  ██║        ╚══███╔╝██║██║   ██║ ${NC}         ${A1}║${NC}"
echo -e " ${A1}║${NC}      ${A4}██║   ██║██║  ███╗███████║          ███╔╝ ██║██║   ██║ ${NC}         ${A1}║${NC}"
echo -e " ${A1}║${NC}      ${AL}██║   ██║██║   ██║██╔══██║         ███╔╝  ██║╚██╗ ██╔╝ ${NC}         ${A1}║${NC}"
echo -e " ${A1}║${NC}      ${A2}╚██████╔╝╚██████╔╝██║  ██║        ███████╗██║ ╚████╔╝  ${NC}         ${A1}║${NC}"
echo -e " ${A1}║${NC}                                                                          ${A1}║${NC}"
echo -e " ${A1}║${NC}                  ${A4}✦ SECURE VPN MANAGEMENT SYSTEM ✦${NC}                    ${A1}║${NC}"
echo -e " ${A1}║${NC}                           ${LG}[ PREMIUM PANEL ]${NC}                         ${A1}║${NC}"
echo -e " ${A1}║${NC}                                                                          ${A1}║${NC}"
echo -e " ${A1}╚══════════════════════════════════════════════════════════════════════════════╝${NC}"
}
...
draw_vps() {
    ...
    local host=$(hostname)
    local total=$(total_user)
    local exp=$(exp_count)

echo -e " ${A1}╔═══════════════════════════════[ INFO VPS ]══════════════════════════════════╗${NC}"
printf  " ${A1}║${NC} ${A3}HOST${NC}    %-24s ${A1}│${NC} ${A3}OS${NC}       Ubuntu 20.04         ${A1}║${NC}
" "$host"
printf  " ${A1}║${NC} ${A3}IP${NC}      %-24s ${A1}│${NC} ${A3}DOMAIN${NC}   %-21s ${A1}║${NC}
" "$ip" "$domain"
printf  " ${A1}║${NC} ${A3}PORT${NC}    %-24s ${A1}│${NC} ${A3}BRAND${NC}    OGH-ZIV              ${A1}║${NC}
" "$port"
printf  " ${A1}║${NC} ${A3}CPU${NC}     %-3s%%                      ${A1}│${NC} ${A3}RAM${NC}      %-15s ${A1}║${NC}
" "$cpu" "${ram_u}/${ram_t} MB"
printf  " ${A1}║${NC} ${A3}DISK${NC}    %-60s ${A1}║${NC}
" "$disk"
printf  " ${A1}║${NC} ${LG}STATUS : RUNNING${NC}  ${A1}│${NC} ${A3}AKUN : %-3s${NC} ${A1}│${NC} ${Y}EXP : %-3s${NC} ${A1}│${NC} ${AL}BOT : OFF${NC}      ${A1}║${NC}
" "$total" "$exp"
echo -e " ${A1}╚══════════════════════════════════════════════════════════════════════════════╝${NC}"
}
