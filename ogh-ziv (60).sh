...
SCRIPT_VERSION="1.0"
SCRIPT_URL="https://raw.githubusercontent.com/chanelog/tes/main/ogh-ziv.sh"
VERSION_URL="https://raw.githubusercontent.com/chanelog/tes/main/version.txt"
...
menu_tema() {
    while true; do
        ...
        echo -e "  \033[38;5;239m──────────────────────────────────────────────────\033[0m"
        printf "  \033[38;5;196mR\033[38;5;208mA\033[38;5;226mI\033[38;5;82mN\033[38;5;51mB\033[38;5;171mO\033[38;5;213mW\033[0m"
        [[ "$cur_theme" == "7" ]] && printf " \033[1;32m▶\033[0m" || printf "  "
        printf "  🌈  \033[2m[ 7]\033[0m  \033[38;5;196mR\033[38;5;208mA\033[38;5;226mI\033[38;5;82mN\033[38;5;51mB\033[38;5;171mO\033[38;5;213mW\033[0m              \033[2mPerisai warna-warni\033[0m\n"
        echo -e "  \033[38;5;239m──────────────────────────────────────────────────\033[0m"
...
main_menu() {
    ...
    while true; do
        ...
        echo -e "  ${A1}${_DASH}${NC}"
        _r2 "${A2}" "[9]  🎨  Tema [${THEME_NAME}]" "${A2}" "[U]  🔄  Cek Update"
        echo -e "  ${A1}${_DASH}${NC}"
